...
{ 
echo '<div  id="drop-shadow" style="margin-top:-42px; width:1020px;height:3px;background-image:url(\'http://golins.com/nminds/wp-content/uploads/2013/08/shadow.png\'); background-repeat:repeat-x;"></div>';

if (is_page(33)) {
    echo '<div style="margin-top:-2px;margin-bottom:0px; width:1020px; height:233px;"><img alt="" src="http://golins.com/nminds/wp-content/uploads/2013/08/who-we-are-banner.png" 
     style="width:1020px;height:233px;"></div>';    
} /* end if page 33 */

    if (is_page(182)) {
    echo '<div style="margin-top:-2px;margin-bottom:0px; width:1020px; height:233px;"><img alt="" src="http://golins.com/nminds/wp-content/uploads/2013/08/howtohelpTop.jpg" 
     style="width:1020px;height:233px;"></div>';   
    
} /* end if page 182 */

    if (is_page(170)) {
     echo '<div style="margin-top:-2px; margin-bottom:0px; width:1020px; height:233px;"><img alt="" src="http://golins.com/nminds/wp-content/uploads/2013/08/Final_NM_OurImpact_bigslide.jpg" 
     style="width:1020px;height:233px;"></div>';   
...
if (is_page(35)) {
    ...
    if ( have_posts() ) { $count = 0;
        ...
        while ( have_posts() ) { 
           ...
           if (in_category('featured') and $count <= 5) { 
...
function homepage_feature_buttons ()
{
    if (is_page(35)) {
        ...
        echo '<div style="float:left;margin-right:20px;"><a title="Who We Are" href="http://golins.com/nminds/who-we-are/"><img class="size-full wp-image-352 alignnone" title="Who We Are" alt="Nurturing Minds - Who We Are" src="http://golins.com/nminds/wp-content/uploads/2013/08/home-who-we-are-architect.png" width="300" height="167" /></a></div>';
        echo '<div style="float:left; margin-right:20px;"> <a title="Impact" href="http://golins.com/nminds/impact/"><img class="size-full wp-image-353 alignnone" title="Impact" alt="Nurturing Minds - Impact" src="http://golins.com/nminds/wp-content/uploads/2013/08/home-impact-architect.png" width="300" height="167" /></a></div>';
        echo '<div style="float:left;"><a title="How To Help" href="http://golins.com/nminds/how-to-help/"><img class="alignnone size-full wp-image-354" title="How to Help" alt="Nurturing Minds - How to Help" src="http://golins.com/nminds/wp-content/uploads/2013/08/home-how-to-help-architect.png" width="300" height="167" /></a></div>';
